                            ...
                            <table class="table table-head-fixed text-nowrap table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $product->subcategory ? $product->subcategory->sub_category_name : 'N/A' }}</td>
                                        <td>{{ $product->subsubcategory ? $product->subsubcategory->sub_sub_category_name : 'N/A' }}</td>
                                        <td>{{ $product->supplier ? $product->supplier->supplier_name : 'N/A' }}</td>
                                        <td>
