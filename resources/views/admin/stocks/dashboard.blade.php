            ...
            <div class="modal-body">
                <form id="stockOutForm" method="POST" action="{{ route('admin.stocks.update', $product->product_id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('stockOutQuantity') is-invalid @enderror" id="stockOutQuantity" name="stockOutQuantity" required min="1">
                        <!-- Error Message -->
                        @error('stockOutQuantity')
